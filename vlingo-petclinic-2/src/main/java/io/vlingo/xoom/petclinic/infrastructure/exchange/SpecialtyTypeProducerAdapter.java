 ...
 */
public class SpecialtyTypeProducerAdapter implements ExchangeAdapter<IdentifiedDomainEvent, IdentifiedDomainEvent, Message> {

  private static final String SCHEMA_PREFIX = "vlingo:apps:io.vlingo.xoom.petclinic";
