...
public class Events {
  ...
  public static class ProductDiscussionRequested extends DomainEvent {
    ...
    public static ProductDiscussionRequested with(final Tenant tenant, final ProductId productId) {
      return new ProductDiscussionRequested(tenant, productId);
    }
    
    public ProductDiscussionRequested(final Tenant tenant, final ProductId productId) {
      this.tenantId = tenant.id;
      this.productId = productId.id;
    }
  }
