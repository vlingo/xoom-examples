...
public class ExchangeDispatcher implements Dispatcher<Dispatchable<Entry<String>, State<String>>>, ConfirmDispatchedResultInterest {
  ...
  public ExchangeDispatcher(final Exchange ...producerExchanges) {
    this.eventsByExchangeName.put("vgo-airports", new HashSet<>());
    this.eventsByExchangeName.get("vgo-airports").add(DepartureRecorded.class.getCanonicalName());
    this.eventsByExchangeName.get("vgo-airports").add(ArrivalRecorded.class.getCanonicalName());
    this.eventsByExchangeName.get("vgo-airports").add(ArrivalPlanned.class.getCanonicalName());
