...
public class ApplicationRegistry {
    ...
    public ApplicationRegistry(final ApplicationContext applicationContext) {
    ...
    public Stage retrieveStage() {
        return retrieveWorld().stage();
    }

    public MessagingClient retrieveMessagingClient() {
        return applicationContext.getBean(MessagingClient.class);
    }
}
