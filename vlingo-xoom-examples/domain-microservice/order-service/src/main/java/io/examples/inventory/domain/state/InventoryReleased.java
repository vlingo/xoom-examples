...
@Singleton
public class InventoryReleased extends InventoryState<InventoryReleased> {

    private final ReservationPending reservationPending;

    public InventoryReleased(Provider<ReservationPending> reservationPending) {
    ...
    public String getName() {
        return InventoryStatus.INVENTORY_RELEASED.name();
    }
}
