...
/**
 * The {@link StockEndpoint} describes a base REST API contract that is used to evolve
 ...
 * @see StockEndpoint
 */
public interface StockEndpoint extends Endpoint {

    String ENDPOINT_NAME = "Stock";
    ...
    Completes<Response> openStock(final OpenStock openStock);

    Completes<Response> loadStock(final AddItems addItems);

    Completes<Response> findByLocation(final String locationName);
