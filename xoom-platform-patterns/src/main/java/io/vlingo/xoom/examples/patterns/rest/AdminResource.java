...
import static io.vlingo.xoom.http.resource.ResourceBuilder.delete;
 ...
 *
 * The {@link io.vlingo.xoom.http.resource.Server} actor that handles web communication
...
class AdminResource {
   ...
   * terminated and terminates the {@link io.vlingo.xoom.http.resource.Dispatcher} before
