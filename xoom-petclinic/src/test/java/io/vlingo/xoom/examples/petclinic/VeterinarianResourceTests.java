...
public class VeterinarianResourceTests extends AbstractRestTest{
    ...
    public void save(){
        ...
        assertThat(data.contact.postalAddress.streetAddress, is(equalTo("Hogwarts st.")));
        ...
        assertThat(data.contact.postalAddress.postalCode, is(equalTo("111")));
    ...
    public void changeName(){
        ...
        data = given()
                ...
                .patch("/veterinarians/{id}/name", data.id)
                .then()
                .statusCode(200)
                .extract()
                .body()
    ...
    public void changeContact(){
        ...
        data = given()
                ...
                .body("{\"contact\": {\n" +
                        ...
                        "    }\n" +
                        "  }}")
                .patch("/veterinarians/{id}/contact", data.id)
                .then()
                .statusCode(200)
                .extract()
                .body()
    ...
    public void specializesIn(){
        ...
        data = given()
                .when()
                .body("{\"specialty\": {\"specialtyTypeId\": \"Behaviour\"}}")
                .patch("/veterinarians/{id}/specialty", data.id)
                .then()
                .statusCode(200)
                .extract()
                .body()
    ...
    public void saveAndFetchById(){
        ...
        data = given()
                .when()
                .get("/veterinarians/{id}", id)
                .then()
                .statusCode(200)
                .extract()
                .body().as(VeterinarianData.class);
    ...
    public void saveAndFetchAll(){
        ...
        List<VeterinarianData> veterinarians = given()
                .when()
                .get("/veterinarians")
                .then()
                .statusCode(200)
                .extract()
                .body().as(new TypeRef<List<VeterinarianData>>() {});
