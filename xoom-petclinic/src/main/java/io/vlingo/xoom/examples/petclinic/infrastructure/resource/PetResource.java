...
public class PetResource extends DynamicResourceHandler {
  ...
  public Resource<?> routes() {
     return resource("PetResource",
        io.vlingo.xoom.http.resource.ResourceBuilder.patch("/pets/{id}/name")
            .param(String.class)
            .body(PetData.class)
            .handle(this::changeName),
        io.vlingo.xoom.http.resource.ResourceBuilder.patch("/pets/{id}/birth")
            .param(String.class)
            .body(PetData.class)
            .handle(this::recordBirth),
        io.vlingo.xoom.http.resource.ResourceBuilder.patch("/pets/{id}/death")
            .param(String.class)
            .body(PetData.class)
            .handle(this::recordDeath),
        io.vlingo.xoom.http.resource.ResourceBuilder.patch("/pets/{id}/kind")
            .param(String.class)
            .body(PetData.class)
            .handle(this::correctKind),
        io.vlingo.xoom.http.resource.ResourceBuilder.patch("/pets/{id}/owner")
            .param(String.class)
            .body(PetData.class)
            .handle(this::changeOwner),
        io.vlingo.xoom.http.resource.ResourceBuilder.post("/pets")
            .body(PetData.class)
            .handle(this::register),
        io.vlingo.xoom.http.resource.ResourceBuilder.get("/pets")
            .handle(this::pets),
        io.vlingo.xoom.http.resource.ResourceBuilder.get("/pets/{id}")
            .param(String.class)
            .handle(this::pet),
        io.vlingo.xoom.http.resource.ResourceBuilder.get("/pets/owners/{id}")
            .param(String.class)
