...
import io.vlingo.developers.petclinic.infrastructure.persistence.SpecialtyTypeProjectionActor;
...
public class SpecialtyTypeProjectionTests {
    ...
    private Projectable createSpecialtyTypeOffered(String id, String name){
        final SpecialtyTypeOffered eventData = new SpecialtyTypeOffered(id, name);
    ...
    public void changeName(){
        ...
        final SpecialtyTypeRenamed eventData = new SpecialtyTypeRenamed("1", "Surgery");
