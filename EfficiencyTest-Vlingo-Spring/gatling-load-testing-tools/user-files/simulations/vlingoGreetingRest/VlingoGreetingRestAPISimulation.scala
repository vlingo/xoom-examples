...
class VlingoSimulation extends Simulation {
  ...
  val httpProtocol = http
    .baseUrl("http://192.168.178.118:18080")
    .acceptHeader("application/json,")
    .contentTypeHeader("application/json")

    val testCase1Scenario = scenario("Vlingo Test Case 1").exec(testCase1())
    val testCase2Scenario = scenario("Vlingo Test Case 2").exec(testCase2())
    val testCase3Scenario = scenario("Vlingo Test Case 3").exec(testCase3())
