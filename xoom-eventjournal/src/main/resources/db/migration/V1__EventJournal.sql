CREATE TABLE xoom_event_journal (
  id                 UUID PRIMARY KEY,
...
CREATE INDEX ON xoom_event_journal (stream_name, stream_version);

CREATE INDEX ON xoom_event_journal (event_timestamp);

CREATE TABLE xoom_event_journal_snapshots (
...
CREATE TABLE xoom_event_journal_offsets (
