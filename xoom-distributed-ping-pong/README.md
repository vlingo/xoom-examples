...
$ mvn clean package
...
console1$ java -jar target/xoom-distributed-ping-pong-1.8.1-SNAPSHOT.jar node1
```
...
```
console2$ java -jar target/xoom-distributed-ping-pong-1.8.1-SNAPSHOT.jar node2
...
console3$ java -jar target/xoom-distributed-ping-pong-1.8.1-SNAPSHOT.jar node3
```
