...
import io.vlingo.xoom.http.resource.sse.MessageEvent;
...
public class PrivateTokenSynchronizerActor extends Actor implements Projection {
  ...
  private SecurityTokenInfo securityTokenInfoFrom(final MessageEvent event) {
    ...
    final io.vlingo.xoom.actors.Address address = addressFactory.from(identities[UserId]);
  ...
  private class SecurityTokenInfo {
    private final io.vlingo.xoom.actors.Address address;
    private final String projectionId;
    private final String securityToken;
    private final String userId;

    private SecurityTokenInfo(io.vlingo.xoom.actors.Address address, final String userId, final String projectionId, final String securityToken) {
