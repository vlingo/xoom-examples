...
import io.vlingo.xoom.http.resource.DefaultJsonMapper;
 ...
 * create one and wire it in the xoom-http.properties file with
 * the action for which it maps resources:
 * <p>{@code action.RESOURCE_NAME.ACTION_NAME.mapper = fully.qualified.classname }</p>
 * <p>As in:</p>
 * <p>{@code action.profile.define.mapper = io.vlingo.xoom.http.sample.user.ProfileDataMapper }</p>
 */
