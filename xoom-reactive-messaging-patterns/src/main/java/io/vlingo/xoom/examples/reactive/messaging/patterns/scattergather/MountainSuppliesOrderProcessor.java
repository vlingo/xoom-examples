...
implements OrderProcessor
{
    ...
    /* @see io.vlingo.xoom.examples.reactive.messaging.patterns.scattergather.OrderProcessor#requestPriceQuoteSubscription(io.vlingo.xoom.examples.reactive.messaging.patterns.scattergather.QuoteSubscriptionRequest) */
    @Override
    ...
    /* @see io.vlingo.xoom.examples.reactive.messaging.patterns.recipientlist.OrderProcessor#requestForQuote(io.vlingo.xoom.examples.reactive.messaging.patterns.recipientlist.RetailBasket) */
    @Override
    ...
    /* @see io.vlingo.xoom.examples.reactive.messaging.patterns.recipientlist.OrderProcessor#remittedPriceQuote(io.vlingo.xoom.examples.reactive.messaging.patterns.recipientlist.PriceQuote) */
    @Override
    ...
    /* @see io.vlingo.xoom.examples.reactive.messaging.patterns.scattergather.OrderProcessor#bestPriceQuotation(io.vlingo.xoom.examples.reactive.messaging.patterns.scattergather.QuotationFulfillment) */
    @Override
